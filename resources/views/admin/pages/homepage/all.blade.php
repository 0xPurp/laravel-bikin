...
<table class="table">
    <thead>
      <tr>
        ...
        <th scope="col">Bouton Start</th>
        <th scope="col">Titre About</th>
        <th scope="col">Description About</th>
        <th scope="col">Bouton About</th>
    ...
    <tr>
        ...
        <td>{{$item->titrehomepage}}</td>
        <td>{{$item->sous_titrehomepage}}</td>
        <td>{{$item->btnstart}}</td>
        <td>{{$item->titreabout}}</td>
        <td>{{$item->sous_titreabout}}</td>
        <td>{{$item->btnabout}}</td>
